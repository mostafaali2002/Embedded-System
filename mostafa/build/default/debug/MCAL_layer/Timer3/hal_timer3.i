...
# 1 "MCAL_layer/Timer3/../../MCAL_layer/mcal_std_types.h" 1
# 11 "MCAL_layer/Timer3/../../MCAL_layer/mcal_std_types.h"
# 1 "MCAL_layer/Timer3/../../MCAL_layer/compile.h" 1
# 12 "MCAL_layer/Timer3/../../MCAL_layer/compile.h"
...
# 12 "MCAL_layer/Timer3/../../MCAL_layer/compile.h" 2
# 11 "MCAL_layer/Timer3/../../MCAL_layer/mcal_std_types.h" 2

# 1 "MCAL_layer/Timer3/../../MCAL_layer/std_libraries.h" 1
# 11 "MCAL_layer/Timer3/../../MCAL_layer/std_libraries.h"
...
# 11 "MCAL_layer/Timer3/../../MCAL_layer/std_libraries.h" 2
...
# 13 "MCAL_layer/Timer3/../../MCAL_layer/std_libraries.h" 2
# 12 "MCAL_layer/Timer3/../../MCAL_layer/mcal_std_types.h" 2
...
# 35 "MCAL_layer/Timer3/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t ;
...
# 14 "MCAL_layer/Timer3/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
...
# 45 "MCAL_layer/Timer3/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
static __attribute__((inline)) void Timer3_Mode_Select(const timer3_t *timer);
...
Std_ReturnType Timer3_Init(const timer3_t *timer){
    ...
    {
        (T3CONbits.TMR3ON = 0) ;
        (T3CONbits.T3CKPS = timer->timer3_prescaler_Value);
...
static __attribute__((inline)) void Timer3_Mode_Select(const timer3_t *timer)
{
    ...
    {
        (T3CONbits.TMR3CS = 1);
        if(1== timer->timer3_counter_mode)
        {
            (T3CONbits.T3SYNC = 1);
        }
        else if(0 == timer->timer3_counter_mode)
        {
            (T3CONbits.T3SYNC = 0);
        }
        else{}
