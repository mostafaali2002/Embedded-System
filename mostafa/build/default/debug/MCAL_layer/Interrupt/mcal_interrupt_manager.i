...
# 11 "MCAL_layer/Interrupt/../../MCAL_layer/mcal_std_types.h"
# 1 "MCAL_layer/Interrupt/../../MCAL_layer/compile.h" 1
# 12 "MCAL_layer/Interrupt/../../MCAL_layer/compile.h"
...
# 12 "MCAL_layer/Interrupt/../../MCAL_layer/compile.h" 2
# 11 "MCAL_layer/Interrupt/../../MCAL_layer/mcal_std_types.h" 2

# 1 "MCAL_layer/Interrupt/../../MCAL_layer/std_libraries.h" 1
# 11 "MCAL_layer/Interrupt/../../MCAL_layer/std_libraries.h"
...
# 11 "MCAL_layer/Interrupt/../../MCAL_layer/std_libraries.h" 2
...
# 13 "MCAL_layer/Interrupt/../../MCAL_layer/std_libraries.h" 2
...
# 12 "MCAL_layer/Interrupt/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/Interrupt/../../MCAL_layer/GPIO/../device_config.h" 1
# 12 "MCAL_layer/Interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
void __attribute__((picinterrupt(("")))) interruptManger(void){
            ...
            &&(RB4_Flag ==0))
    {
     ...
     if((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB5 == GPIO_HIGH)
             &&(RB5_Flag ==1))
    {
        RB5_Flag =0 ;
        RB5_ISR(1);
    ...
    if((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB5 == GPIO_LOW)
            &&(RB5_Flag ==0))
    {
        RB5_Flag = 1 ;
        RB5_ISR(0);
      ...
      if((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB6 == GPIO_HIGH)
             &&(RB6_Flag ==1))
    {
        RB6_Flag =0 ;
        RB6_ISR(1);
    ...
    if((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB6 == GPIO_LOW)
            &&(RB6_Flag ==0))
    {
        RB6_Flag = 1 ;
        RB6_ISR(0);
     ...
     if((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB7 == GPIO_HIGH)
             &&(RB7_Flag ==1))
    {
        RB7_Flag =0 ;
        RB7_ISR(1);
    ...
    if((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB7 == GPIO_LOW)
            &&(RB7_Flag ==0))
    {
        RB7_Flag = 1 ;
        RB7_ISR(0);
