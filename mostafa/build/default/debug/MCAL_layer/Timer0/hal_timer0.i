...
# 11 "MCAL_layer/Timer0/../../MCAL_layer/mcal_std_types.h"
# 1 "MCAL_layer/Timer0/../../MCAL_layer/compile.h" 1
# 12 "MCAL_layer/Timer0/../../MCAL_layer/compile.h"
...
# 12 "MCAL_layer/Timer0/../../MCAL_layer/compile.h" 2
# 11 "MCAL_layer/Timer0/../../MCAL_layer/mcal_std_types.h" 2

# 1 "MCAL_layer/Timer0/../../MCAL_layer/std_libraries.h" 1
# 11 "MCAL_layer/Timer0/../../MCAL_layer/std_libraries.h"
...
# 11 "MCAL_layer/Timer0/../../MCAL_layer/std_libraries.h" 2
...
# 13 "MCAL_layer/Timer0/../../MCAL_layer/std_libraries.h" 2
# 12 "MCAL_layer/Timer0/../../MCAL_layer/mcal_std_types.h" 2
...
# 35 "MCAL_layer/Timer0/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t ;
...
# 45 "MCAL_layer/Timer0/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
static __attribute__((inline)) void Timer0_Prescaler_Config(const timer0_t *timer);
static __attribute__((inline)) void Timer0_Mode_Select(const timer0_t *timer);
static __attribute__((inline)) void Timer0_Register_Size(const timer0_t *timer);
void TM0_ISR(void);
...
static __attribute__((inline)) void Timer0_Prescaler_Config(const timer0_t *timer)
{
    ...
    else if(0 == timer->prescaler_enable)
    {
        (T0CONbits.PSA = 1);
    }
    else {}
...
static __attribute__((inline)) void Timer0_Mode_Select(const timer0_t *timer)
{
    ...
    else if(0 == timer->timer0_mode)
    {
        (T0CONbits.T0CS = 1);
        if(1 == timer->timer0_counter_edge)
        {
            (T0CONbits.T0SE = 0);
        }
        else if(0 == timer->timer0_counter_edge)
        {
            (T0CONbits.T0SE = 1);
        }
        else{}
