...
# 1 "MCAL_layer/Timer1/../../MCAL_layer/mcal_std_types.h" 1
# 11 "MCAL_layer/Timer1/../../MCAL_layer/mcal_std_types.h"
# 1 "MCAL_layer/Timer1/../../MCAL_layer/compile.h" 1
# 12 "MCAL_layer/Timer1/../../MCAL_layer/compile.h"
...
# 12 "MCAL_layer/Timer1/../../MCAL_layer/compile.h" 2
# 11 "MCAL_layer/Timer1/../../MCAL_layer/mcal_std_types.h" 2

# 1 "MCAL_layer/Timer1/../../MCAL_layer/std_libraries.h" 1
# 11 "MCAL_layer/Timer1/../../MCAL_layer/std_libraries.h"
...
# 11 "MCAL_layer/Timer1/../../MCAL_layer/std_libraries.h" 2
...
# 13 "MCAL_layer/Timer1/../../MCAL_layer/std_libraries.h" 2
# 12 "MCAL_layer/Timer1/../../MCAL_layer/mcal_std_types.h" 2
...
# 12 "MCAL_layer/Timer1/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/Timer1/../../MCAL_layer/GPIO/../device_config.h" 1
# 12 "MCAL_layer/Timer1/../../MCAL_layer/GPIO/hal_gpio.h" 2
# 35 "MCAL_layer/Timer1/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t ;
...
# 14 "MCAL_layer/Timer1/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
...
# 45 "MCAL_layer/Timer1/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
Std_ReturnType Timer1_Init(const timer1_t *timer){
    ...
    {
        (T1CONbits.TMR1ON = 0) ;
        (T1CONbits.T1CKPS = timer->timer1_prescaler_Value);
...
# 48 "MCAL_layer/Timer1/hal_timer1.c"
(INTCONbits.PEIE = 1) ;
(INTCONbits.GIE = 1) ;
...
static __attribute__((inline)) void Timer1_Mode_Select(const timer1_t *timer)
{
    ...
    {
        (T1CONbits.TMR1CS = 1);
        if(1== timer->timer1_counter_mode)
        {
            (T1CONbits.T1SYNC = 1);
        }
        else if(0 == timer->timer1_counter_mode)
        {
            (T1CONbits.T1SYNC = 0);
        }
        else{}
