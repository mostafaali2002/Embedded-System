...
# 1 "MCAL_layer/USART/../../MCAL_layer/mcal_std_types.h" 1
# 11 "MCAL_layer/USART/../../MCAL_layer/mcal_std_types.h"
# 1 "MCAL_layer/USART/../../MCAL_layer/compile.h" 1
# 12 "MCAL_layer/USART/../../MCAL_layer/compile.h"
...
# 12 "MCAL_layer/USART/../../MCAL_layer/compile.h" 2
# 11 "MCAL_layer/USART/../../MCAL_layer/mcal_std_types.h" 2

# 1 "MCAL_layer/USART/../../MCAL_layer/std_libraries.h" 1
# 11 "MCAL_layer/USART/../../MCAL_layer/std_libraries.h"
...
# 11 "MCAL_layer/USART/../../MCAL_layer/std_libraries.h" 2
...
# 13 "MCAL_layer/USART/../../MCAL_layer/std_libraries.h" 2
# 12 "MCAL_layer/USART/../../MCAL_layer/mcal_std_types.h" 2
...
# 12 "MCAL_layer/USART/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/USART/../../MCAL_layer/GPIO/../device_config.h" 1
# 12 "MCAL_layer/USART/../../MCAL_layer/GPIO/hal_gpio.h" 2
# 35 "MCAL_layer/USART/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t ;
...
# 14 "MCAL_layer/USART/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_layer/USART/../../MCAL_layer/Interrupt/mcal_interrupt_gen_cfg.h" 1
# 14 "MCAL_layer/USART/../../MCAL_layer/Interrupt/mcal_interrupt_config.h" 2
# 45 "MCAL_layer/USART/../../MCAL_layer/Interrupt/mcal_interrupt_config.h"
typedef enum {
...
static void USART_BaudRate_Calculation(const usart_t *usart){
    ...
    switch(usart->baudrate_gen)
    {
       case BAUDRATE_ASYNC_8BIT_LOW_SPEED :
           ...
           TXSTAbits.BRGH =0;
           BAUDCONbits.BRG16 =0 ;
           USART_BaudRate = ((8000000UL /(float)usart->baudrate)/64)-1;
         break ;
       case BAUDRATE_ASYNC_8BIT_HIGH_SPEED :
            TXSTAbits.SYNC = 0 ;
           TXSTAbits.BRGH =1;
           BAUDCONbits.BRG16 =0 ;
           USART_BaudRate = ((8000000UL /(float)usart->baudrate)/16)-1;
         break ;
       ...
       case BAUDRATE_ASYNC_16BIT_HIGH_SPEED :
           ...
           TXSTAbits.BRGH =1;
           BAUDCONbits.BRG16 =1 ;
           USART_BaudRate = ((8000000UL /(float)usart->baudrate)/4)-1;
         break ;
...
static void USART_ASYNC_TX_Init(const usart_t *usart){
    if(1 == usart->usart_tx.usart_tx_enable){
        TXSTAbits.TXEN = 1 ;
        USART_TX_InterruptHandler = usart->USART_TX_InterruptHandler;
        if(1 == usart->usart_tx.usart_tx_interrupt_enable)
        {
            PIE1bits.TXIE = 1 ;

            (PIE1bits.TXIE = 1);
# 163 "MCAL_layer/USART/hal_usart.c"
(INTCONbits.PEIE = 1) ;
(INTCONbits.GIE = 1) ;
        ...
        else if(0 == usart->usart_tx.usart_tx_interrupt_enable){
            PIE1bits.TXIE = 0 ;
        }
         else{ }
        if(1 == usart->usart_tx.usart_tx_9bit_enable)
        {
            TXSTAbits.TX9 =1 ;
        }

        else if(0 == usart->usart_tx.usart_tx_9bit_enable){
            TXSTAbits.TX9 =0 ;
        }
         else{ }
...
static void USART_ASYNC_RX_Init(const usart_t *usart){
     if(1 == usart->usart_rx.usart_rx_enable){
         RCSTAbits.CREN = 1 ;

        if(1 == usart->usart_rx.usart_rx_interrupt_enable)
        {
            PIE1bits.RCIE = 1 ;
...
# 213 "MCAL_layer/USART/hal_usart.c"
(INTCONbits.PEIE = 1) ;
(INTCONbits.GIE = 1) ;
        ...
        else if(0 == usart->usart_rx.usart_rx_interrupt_enable){
            PIE1bits.RCIE = 0 ;
        }
         else{ }
        if(1 == usart->usart_rx.usart_rx_9bit_enable)
        {
            RCSTAbits.RX9 =1 ;
        }

        else if(0 == usart->usart_rx.usart_rx_9bit_enable){
            RCSTAbits.RX9 =0 ;
        }
         else{ }
