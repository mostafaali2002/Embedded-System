...
# 1 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/../compile.h" 1
# 12 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/../compile.h"
...
# 12 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/../compile.h" 2
...
Std_ReturnType lcd_4bit_initialize(const chr_lcd_4bit_t *lcd){
        ...
        if (((void*)0) == lcd) {
            ...
            for(counter_pin = 0 ; counter_pin < 4 ; counter_pin++){
...
Std_ReturnType lcd_8bit_initialize(const chr_lcd_8bit_t *lcd){
      Std_ReturnType ret = (Std_ReturnType)0x01;
        ...
        if (((void*)0) == lcd) {
            ...
            ret = gpio_pin_intialize(&(lcd->lcd_rs));
            ret = gpio_pin_intialize(&(lcd->lcd_en));
            for(counter_pin = 0 ; counter_pin < 8 ; counter_pin++){
                 ret = gpio_pin_intialize(&(lcd->lcd_data[counter_pin]));
            }
            _delay((unsigned long)((20)*(8000000UL/4000.0)));
